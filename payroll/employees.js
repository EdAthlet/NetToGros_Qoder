...
const PayrollEmployees = (function() {
    ...
    function wireEmployeeReport() {
        if (typeof PayrollEmployeeReport === 'undefined') return;
        PayrollEmployeeReport.init({
            getEmployees: getEmployees,
            getEmployeeName: getEmployeeName,
            getEmployeeNumber: getEmployeeNumber,
            getFamilyStatusLabel: getFamilyStatusLabel,
            getEmployeePayTypeLabel: getEmployeePayTypeLabel,
            getPayFrequencyLabel: getPayFrequencyLabel,
            getEmployeePayAmount: getEmployeePayAmount,
            getEmployeePayAmountLabel: getEmployeePayAmountLabel,
            getEmployeeIban: getEmployeeIban,
            escapeHtml: escapeHtml,
            safeFormatCurrency: safeFormatCurrency,
            showValidationErrors: showValidationErrors,
            refreshList: renderEmployeeList
        });
    }
    ...
    function renderEmployeeList() {
        ...
        if (count === 0) {
            ...
            html += '</div>';
            html += typeof PayrollEmployeeReport !== 'undefined' ? PayrollEmployeeReport.renderControls() : '';
        }
        ...
        if (typeof PayrollEmployeeReport !== 'undefined') {
            PayrollEmployeeReport.bindEvents(el);
        }
    }
