...
**UI:** PAYE Practice → **Help** tab (header) or workspace Help tab  
...
Take Home Pay · Bulk Calculator · PAYE Practice · Pensions · Support
...
| Date | Change |
|------|--------|
| 2026-09 | Week 1 copy/rename: PAYE Practice, Manual credits / RPN practice; Cloud is fake `/api/rpn` not live ROS |
